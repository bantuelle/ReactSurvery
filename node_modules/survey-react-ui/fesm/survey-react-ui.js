...
class SurveyQuestionMatrix extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        var header = !this.question.showHeader ? null : (React.createElement("thead", null,
...
class SurveyFilePreview extends SurveyElementBase {
    ...
    renderElement() {
        const content = this.question.supportFileNavigator ? this.question.renderedPages.map((page, index) => { return (React.createElement(SurveyFilePage, { page: page, question: this.question, key: page.id })); })
    ...
    */
    ...
    renderElement() {
        ...
        return (React.createElement("div", { className: cssClasses.root, onKeyDown: this.handleOnKeyDown },
            React.createElement("label", { className: itemClass, onClick: this.handleOnClick },
...
class SurveyQuestionPanelDynamic extends SurveyQuestionElementBase {
    ...
    renderElement() {
        ...
        const btnAdd = this.question.isRenderModeList && this.question["showLegacyNavigation"]
