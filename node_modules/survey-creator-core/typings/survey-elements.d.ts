import { DragDropCore, DragTypeOverMeEnum, IElement, IPanel, IShortcutText, ISurveyElement, JsonObject, PageModel, QuestionPanelDynamicModel, QuestionRowModel } from "survey-core";
...
export declare function calculateDragOverLocation(clientX: number, clientY: number, rect: DOMRectInit, direction?: "top-bottom" | "left-right"): DragTypeOverMeEnum;
export declare function isPanelDynamic(element: ISurveyElement): element is QuestionPanelDynamicModel;
