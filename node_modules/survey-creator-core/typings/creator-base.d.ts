...
export declare class SurveyCreatorModel extends Base implements ISurveyCreatorOptions, ICreatorSelectionOwner, ILocalizableOwner {
    ...
    onCreatorThemeSelected: EventBase<SurveyCreatorModel, {
        theme: ICreatorTheme;
    }>;
