...
.svc-logic-operator.svc-logic-operator--error {
  ...
  box-shadow: inset 0 0 0 2px var(--ctr-expression-item-text-color-parameter-error, var(--sjs-semantic-red-background-500, #e50a3e));
}
...
.svc-toolbox__category-header-wrapper {
  padding: var(--ctr-toolbox-group-header-margin-top, var(--sjs-spacing-x1)) var(--ctr-toolbox-group-header-margin-left, 0px) var(--ctr-toolbox-group-header-margin-bottom, var(--sjs-spacing-x1)) var(--ctr-toolbox-group-header-margin-left, 0px);
  margin-inline-start: calc(0px - var(--ctr-toolbox-group-padding-left, var(--sjs-spacing-x150)));
  margin-inline-end: calc(0px - var(--ctr-toolbox-group-padding-right, var(--sjs-spacing-x150)));
  align-self: stretch;
}
...
.svc-toolbox__category-header {
  ...
  padding-inline-start: var(--ctr-toolbox-group-header-padding-left, var(--sjs-spacing-x3));
  box-shadow: inset 0 var(--ctr-toolbox-group-header-border-width-top, 0px) var(--ctr-toolbox-group-header-border-color, var(--sjs-border-25, #d4d4d4)), inset calc(0px - var(--ctr-toolbox-group-header-border-width-right, 0px)) 0 var(--ctr-toolbox-group-header-border-color, var(--sjs-border-25, #d4d4d4)), inset 0 calc(0px - var(--ctr-toolbox-group-header-border-width-bottom, var(--sjs-stroke-x1))) var(--ctr-toolbox-group-header-border-color, var(--sjs-border-25, #d4d4d4)), inset var(--ctr-toolbox-group-header-border-width-left, 0px) 0 var(--ctr-toolbox-group-header-border-color, var(--sjs-border-25, #d4d4d4));
  box-sizing: border-box;
  width: 100%;
...
.spg-dropdown {
  display: flex;
  padding-right: calc(var(--ctr-editor-buttons-gap, var(--sjs-spacing-x05)) + var(--ctr-editor-button-padding-right, var(--sjs-spacing-x1)) + var(--ctr-editor-button-padding-left, var(--sjs-spacing-x1)) + var(--ctr-editor-button-icon-width, var(--sjs-font-size-x3)));
  min-height: calc(var(--ctr-editor-button-icon-height, var(--sjs-font-size-x3)) + var(--ctr-editor-button-padding-top, var(--sjs-spacing-x1)) + var(--ctr-editor-button-padding-bottom, var(--sjs-spacing-x1)) + var(--ctr-editor-padding-top, var(--sjs-spacing-x05)) + var(--ctr-editor-padding-bottom, var(--sjs-spacing-x05)));
}

.spg-dropdown--empty .spg-dropdown__value {
  min-height: var(--ctr-font-default-line-height, var(--sjs-line-height-x3));
}
...
.spg-table__cell:not(.spg-table__cell--detail-panel) .spg-dropdown_chevron-button {
  --tmp-dropdown-button-margin: calc(-1 * var(--ctr-data-table-cell-drop-down-arrow-width, var(--sjs-font-size-x3)));
  width: var(--ctr-data-table-cell-drop-down-arrow-width, var(--sjs-font-size-x3));
  height: var(--ctr-data-table-cell-drop-down-arrow-height, var(--sjs-font-size-x3));
  margin-inline-start: var(--tmp-dropdown-button-margin, calc(-3 * (var(--sjs-base-unit, var(--base-unit, 8px)))));
  padding: var(--ctr-data-table-cell-padding-top, var(--sjs-spacing-x1)) 0 var(--ctr-data-table-cell-padding-bottom, var(--sjs-spacing-x1)) 0;
}
